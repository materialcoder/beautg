...
describe('test Input component', () => {
  it('should render the correct default Input', () => {
    ...
    expect(testNode).toHaveClass('beautg-input-inner')
  ...
  it('should render diffrent input size on size property', () => {
    const wrapper = render(<Input size="lg" placeholder="sizes" />)
    const testContainer = wrapper.container.querySelector('.beautg-input-wrapper') as HTMLInputElement
    expect(testContainer).toHaveClass('input-size-lg')
  })
  it('should render prepend and append element on prepend/append', () => {
    const {queryByText, container} = render(<Input placeholder="pend" prepend="https://" append=".com" />)
    const testContainer = container.querySelector('.beautg-input-wrapper')
